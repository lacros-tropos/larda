...
from pyLARDA import __version__, __author__
...
# somehow not longer needed for new sphinx
#source_parsers = {
#        '.md': CommonMarkParser,
#}
...
latex_documents = [
    (master_doc, 'pyLARDA.tex', 'pyLARDA Documentation',
     'Bühl, Radenz', 'manual'),
]
...
man_pages = [
    (master_doc, 'pylarda', 'pyLARDA Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyLARDA', 'pyLARDA Documentation',
     author, 'pyLARDA', 'One line description of project.',
     'Miscellaneous'),
]
